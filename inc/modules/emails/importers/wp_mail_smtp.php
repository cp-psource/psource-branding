...
class PSToolkit_SMTP_Importer_WP_Mail_SMTP extends PSToolkit_SMTP_Importer {
	...
	public function __construct() {
		...
		add_filter( 'pstoolkit_smtp_import_wp_mail_smtp_mail_from_name_force', array( $this, 'sanitize_on' ) );
