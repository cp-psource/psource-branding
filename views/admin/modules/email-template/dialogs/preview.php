	...
	<div class="sui-modal-content" id="<?php echo esc_attr( $id ); ?>" aria-labelledby="<?php echo esc_attr( $id ) . '-title'; ?>" role="dialog" aria-modal="true">
		<div class="sui-box" role="document">
			<div class="sui-box-header">
				...
				<h3 class="sui-box-title" id="<?php echo esc_attr( $id ) . '-title'; ?>"><?php esc_html_e( 'Vorschau', 'ub' ); ?></h3>
			</div>
			<div class="sui-box-body"></div>
			<div class="sui-box-footer">
				<div class="sui-actions-right">
					<button class="sui-button" data-modal-close><?php esc_html_e( 'Schließen', 'ub' ); ?></button>
				</div>
			</div>
		</div>
	</div>
