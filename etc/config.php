...
function pstoolkit_get_groups_list() {
	$groups = array(
		'admin'     => array(
			...
			'description'           => __( 'Passe die verschiedenen Teile Deines WordPress-Verwaltungsbereichs an.', 'ub' ),
		),
		'widgets'   => array(
			'icon'                  => 'thumbnails',
			'title'                 => __( 'Widgets', 'ub' ),
			'documentation_chapter' => 'widgets',
			'description'           => __( 'Passe die vorhandenen Widgets an oder füge dem WordPress-Dashboard benutzerdefinierte Feeds hinzu. Aktualisiert außerdem das im Front-End angezeigte Meta-Widget entsprechend Deinem Branding.', 'ub' ),
		),
		'emails'    => array(
			'icon'                  => 'mail',
			'title'                 => __( 'E-Mails', 'ub' ),
			'documentation_chapter' => 'email',
			'description'           => __( 'Passe das Design, den Inhalt und die Header ausgehender E-Mails von Deiner WordPress-Webseite vollständig an oder richte einen SMTP-Server ein.', 'ub' ),
		),
		'front-end' => array(
			'icon'                  => 'monitor',
			'title'                 => __( 'Frontend', 'ub' ),
			'documentation_chapter' => 'front-end',
			'description'           => __( 'Passe jeden Teil des Frontends Deiner WordPress-Webseite an das Theme Deiner Webseite an.', 'ub' ),
		),
		'data'      => array(
...
function pstoolkit_get_modules_list( $mode = 'full' ) {
	...
	$modules = array(
		...
		'admin/menu.php'                        => array(
			...
			'description'    => __( 'Mit diesem Modul kannst Du das Admin-Menü vollständig nach Benutzerrolle oder nach benutzerdefiniertem Benutzer anpassen. Sie können die Menüelemente nach Bedarf hinzufügen, ausblenden und neu anordnen. Du kannst den Link Manager oder den Link "Dashboard" im Admin-Bereich für Benutzer ohne Webseite aktivieren (in WP Multisite).', 'ub' ),
			'group'          => 'admin',
			'public'         => true,
			'wp'             => '3.5',
			'options'        => array(
		...
		'admin/message.php'                     => array(
			...
			'description'    => __( 'Zeige eine benutzerdefinierte Nachricht auf den WordPress-Administrationsseiten an.', 'ub' ),
			'group'          => 'admin',
			'options'        => array(
				'ub_admin_message',
				/**
		...
		'utilities/images.php'                  => array(
			...
			'since'          => '1.0.0',
			'name'           => __( 'Bilder', 'ub' ),
			'description'    => __( 'Füge ein Favicon hinzu und überschreibe das Standardlimit für die Bilddateigröße von WordPress basierend auf verschiedenen Benutzerrollen.', 'ub' ),
			'group'          => 'utilities',
			'public'         => true,
			'wp'             => '4.3',
			'options'        => array(
		...
		'utilities/site-generator.php'          => array(
			...
			'description'    => __( 'Ändere die "Generatorinformationen" und "Generatorlink" von WordPress in etwas, das Du bevorzugst.', 'ub' ),
			'public'         => true,
			'group'          => 'utilities',
			'options'        => array(
		...
		'emails/headers.php'                    => array(
			...
			'description'    => __( 'Lege einen Standard-Absendernamen und eine Absender-E-Mail für Deine ausgehenden WordPress-E-Mails fest.', 'ub' ),
			'public'         => true,
			'group'          => 'emails',
			'options'        => array(
				'ub_emails_headers',
		...
		'emails/template.php'                   => array(
			...
			'description'    => __( 'Höre auf, nur Text-E-Mails von Deiner Website zu senden. Wähle entweder aus unseren vorgefertigten E-Mail-Vorlagen oder bringe Deine eigene HTML-Vorlage mit. Dieses Plugin umschließt jede in der HTML-Vorlage gesendete WordPress-E-Mail.', 'ub' ),
			'public'         => true,
			'group'          => 'emails',
			'options'        => array(
				'ub_email_template',
		...
		'utilities/export.php'                  => array(
			...
			'description'            => __( 'Verwende dieses Tool, um die PSToolkit-Konfigurationen zu exportieren.', 'ub' ),
			'group'                  => 'data',
			'instant'                => 'on',
			'allow-override'         => 'allow',
			'allow-override-message' => 'hide',
		...
		'widgets/meta-widget.php'               => array(
			...
			'description'      => __( 'Benenne das Standard-Meta-Widget in allen Blogs mit mehreren Webseiten mit einem Widget mit dem Link "Powered By" für Deine Webseite. Der Link "WordPress.org" im Meta-Widget wird durch den Titel Deiner Webseite ersetzt, der auf Deine Webseite verweist.', 'ub' ),
			'public'           => true,
			'group'            => 'widgets',
			'status-indicator' => 'hide',
		...
		'emails/email-logs.php'                 => array(
			...
			'description'      => __( 'Mit dem Psource WP Toolkit erhältst Du detaillierte Informationen zu Deinen E-Mails. Du kannst die Empfängerinformationen überprüfen und den gesamten Protokollverlauf exportieren.', 'ub' ),
			'public'           => true,
			'only_pro'         => false,
			'group'            => 'emails',
