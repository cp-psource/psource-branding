<?php
/**
 * PSToolkit Dashboard Feeds List Table class.
 *
 * @package PSToolkit
 * @subpackage Widgets
 */
if ( ! class_exists( 'PSToolkit_Dashboard_Feeds_Table' ) ) {
	if ( ! class_exists( 'PSToolkit_List_Table' ) ) {
		$file = pstoolkit_files_dir( 'class-pstoolkit-list-table.php' );
		require_once $file;
	}
	class PSToolkit_Dashboard_Feeds_Table extends PSToolkit_List_Table {
		...
		public function column_title( $item ) {
			...
			if ( isset( $item['link'] ) && ! empty( $item['link'] ) ) {
				printf(
					'<a class="pstoolkit-feed-ellipsis" data-modal-open="%s" data-modal-mask="true">%s</a>',
		...
		public function column_url( $item ) {
			if ( isset( $item['url'] ) && ! empty( $item['url'] ) ) {
				echo '<div class="pstoolkit-feed-ellipsis">';
		...
		public function column_link( $item ) {
			...
			printf(
				...
				esc_attr__( 'Feed-Details anzeigen', 'ub' )
			);
		...
		public function column_meta( $item ) {
			...
			echo '<div class="sui-box-body pstoolkit-accordion-body">';
			...
			$delete_dialog_configuration = array(
				'title'       => __( 'Lösche Dashboard Feed', 'ub' ),
				'description' => __( 'Möchtest Du diesen Dashboard-Feed wirklich dauerhaft löschen?', 'ub' ),
			);
		...
		public function no_items() {
			$args = array(
				'title'       => __( 'Noch kein Feed hinzugefügt!', 'ub' ),
				'description' => __( 'Du hast noch keinen Dashboard-Feed hinzugefügt. Klicke auf die Schaltfläche "+Feed hinzufügen", um einen hinzuzufügen.', 'ub' ),
		...
		protected function bulk_actions( $which = '' ) {
			...
			echo '<option value="-1">' . __( 'Massenaktionen', 'ub' ) . "</option>\n";
			$actions = array(
