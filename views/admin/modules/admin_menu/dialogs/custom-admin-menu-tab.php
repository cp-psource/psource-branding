<script type="text/html" id="tmpl-menu-tab">
	<button type="button"
	        role="tab"
	        id="pstoolkit-custom-admin-menu-tab-{{ data.key }}"
	        data-menu-key="{{ data.key }}"
	        data-content="pstoolkit-custom-admin-menu-tab-content-{{ data.key }}"
	        class="sui-tab-item <# if(data.is_active) { #>active<# } #>"
	        aria-controls="pstoolkit-custom-admin-menu-tab-content-{{ data.key }}"
	        aria-selected="false"
	        tabindex="-1">
		{{ data.label }}
