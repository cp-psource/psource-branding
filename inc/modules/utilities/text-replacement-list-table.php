<?php
/**
 * PSToolkit Text Replacement List Table class.
 *
 * @package PSToolkit
 * @subpackage Utilites
 */
if ( ! class_exists( 'PSToolkit_Text_Replacement_List_Table' ) ) {
	if ( ! class_exists( 'PSToolkit_List_Table' ) ) {
		$file = pstoolkit_files_dir( 'class-pstoolkit-list-table.php' );
		require_once $file;
	}
	class PSToolkit_Text_Replacement_List_Table extends PSToolkit_List_Table {
		...
		public function no_items() {
			$args = array(
				'title'       => __( 'Noch kein Textersatz hinzugefügt!', 'ub' ),
				'description' => __( 'Du hast noch keine Textersetzungsregel definiert. Klicke auf die Schaltfläche "+Regel hinzufügen", um eine hinzuzufügen.', 'ub' ),
		...
		protected function bulk_actions( $which = '' ) {
			$this->pstoolkit_bulk_actions( $which, 'pstoolkit-text-replacement-delete-bulk' );
		}
	}
}
