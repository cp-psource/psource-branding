...
?>
			...
			<div class="sui-box-footer sui-space-between sui-flatten">
				...
				<button type="button" class="sui-modal-close sui-button sui-button-blue pstoolkit-copy-settings-copy-button" data-module="<?php echo esc_attr( $module['module'] ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( $dialog_id ) ); ?>" disabled="disabled"><?php echo esc_html_x( 'Copy', 'Dialog "Copy Settings" button', 'ub' ); ?></button>
			</div>
		</div>
	</div>
</div>
