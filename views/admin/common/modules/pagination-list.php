...
if ( ! $short_pagination ) {
	...
	<li class="sui-pagination--start">
		<a href="<?php echo esc_url( $base_url ); ?>" <?php disabled( $paged <= 1 ); ?>>
			...
			<span class="sui-screen-reader-text"><?php esc_html_e( 'Zur ersten Seite gehen', 'ub' ); ?></span>
		</a>
	</li>
	...
	<li class="sui-pagination--next">
		<a href="<?php echo esc_url( $u ); ?>" <?php disabled( $paged <= 1 ); ?>>
			...
			<span class="sui-screen-reader-text"><?php esc_html_e( 'Zurück zur letzten Seite', 'ub' ); ?></span>
		</a>
	</li>
	<?php
}
...
if ( ! $short_pagination ) {
	...
	<li class="sui-pagination--next">
		<a href="<?php echo esc_url( $u ); ?>" <?php disabled( $paged >= $max ); ?>>
			...
			<span class="sui-screen-reader-text"><?php esc_html_e( 'Zur nächsten Seite gehen', 'ub' ); ?></span>
		</a>
	</li>
	<?php
	...
	<li class="sui-pagination--end">
		<a href="<?php echo esc_url( $u ); ?>" <?php disabled( $paged >= $max ); ?>>
			...
			<span class="sui-screen-reader-text"><?php esc_html_e( 'Zur letzten Seite gehen', 'ub' ); ?></span>
		</a>
	</li>
	<?php
}
