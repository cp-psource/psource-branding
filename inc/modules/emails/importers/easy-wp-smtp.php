...
class PSToolkit_SMTP_Importer_Easy_WP_SMTP extends PSToolkit_SMTP_Importer {
	...
	public function __construct() {
		...
		add_filter( 'pstoolkit_smtp_import_swpsmtp_options_smtp_settings_password', array( $this, 'base64_decode' ) );
		add_filter( 'pstoolkit_smtp_import_swpsmtp_options_force_from_name_replace', array( $this, 'sanitize_on' ) );
		add_filter( 'pstoolkit_smtp_import_swpsmtp_options_smtp_settings_insecure_ssl', array( $this, 'sanitize_on' ) );
	}
