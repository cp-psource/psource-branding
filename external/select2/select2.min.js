    ...
    var b = function() {
            ...
            return function() {
                ...
                return {
                    ...
                    inputTooShort: function(a) { return "Bitte gib " + (a.minimum - a.input.length) + " oder mehr Zeichen ein" },
                    loadingMore: function() { return "Weitere Ergebnisse werden geladen…" },
                    maximumSelected: function(a) { var b = "Du kannst nur " + a.maximum + " Element auswählen"; return 1 != a.maximum && (b += "s"), b },
