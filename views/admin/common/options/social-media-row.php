<div class="sui-accordion-item">
	<div class="sui-accordion-item-header">
		...
		<div class="sui-accordion-col-auto pstoolkit-social-logo-remove-container">
			<button type="button" class="sui-button-icon sui-button-red pstoolkit-social-logo-remove" data-id="<?php echo esc_attr( $id ); ?>"><i class="sui-icon-trash" aria-hidden="true"></i></button>
		</div>
