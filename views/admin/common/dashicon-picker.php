...
<script type="text/html" id="tmpl-dashicon-picker">
	<div class="pstoolkit-dashicon-picker">
		<div class="pstoolkit-dashicon-picker-search">
		...
		<div class="pstoolkit-dashicon-picker-icons">
			<?php foreach ( $list as $group_id => $group ) : ?>
				<div class="pstoolkit-dashicon-picker-group">
					<label class="sui-label">
						<?php echo esc_html( $group['title'] ); ?>
					</label>

					<div class="pstoolkit-dashicon-picker-group-inner">
