 ...
 * @since 2.3.0
 */
if ( ! class_exists( 'PSToolkit_Admin_Stats' ) ) {
	class PSToolkit_Admin_Stats extends PSToolkit_Base {
		/**
		 * Option name.
		 *
		 * @since 2.3.0
		...
		public function __construct() {
			parent::__construct();
			add_action( 'pstoolkit_after_module_form', array( $this, 'collect' ) );
			add_action( 'pstoolkit_admin_stats_write', array( $this, 'collect_write' ) );
			 ...
			 * @since 3.2.0
			 */
			add_filter( 'pstoolkit_force_local_option', array( $this, 'force_local' ), 10, 2 );
		}
		...
		public function get_stats() {
			$stats = pstoolkit_get_option( $this->option_name, array() );
		...
		public function collect_write( $option_name ) {
			 ...
			 * save
			 */
			pstoolkit_update_option( $this->option_name, $stats );
		}
		...
		public function get_frequently_used_modules( $mode = 'default' ) {
			 ...
			 */
			$number_of_module_to_show = apply_filters( 'pstoolkit_admin_stats_number_od_modules_to_show', 5 );
